...
interface CategoryRepository {
    ...
    suspend fun getChildrenCategories(pid: Int): Flow<List<Category>>
...
class CategoryRepositoryImpl(private val db : AppRoomDatabase): CategoryRepository {
    ...
    override suspend fun getCategory(id: Int) = db.categoryDao().get(id)
    override suspend fun getChildrenCategories(pid: Int): Flow<List<Category>> = db.categoryDao().getChildrenCategory(pid)
